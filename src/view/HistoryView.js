    ...
    <View style={{flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'white'}}>
        <View style={{flexDirection:'row', marginTop:12}}>
            <TouchableOpacity onPress={()=>{handleUpdateMiningHistory(); setType('mining')}}>
                <Text style={type === 'mining' ? styles.selectedText : styles.notSelectedText}>Minning Record</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{handleUpdateBattleHistory(); setType('battle');}} style={{marginLeft:72}}>
                <Text style={type === 'battle' ? styles.selectedText : styles.notSelectedText}>Battle Record</Text>
            </TouchableOpacity>
        </View>
            ...
            <FlatList
                ListHeaderComponent={()=>{
                    return <View style={{width:'100%',justifyContent:'center', justifyContent:'center', marginTop:24,}}>
                        <Text style={{marginRight:'auto',marginLeft:4, marginBottom:10, fontFamily:'SUIT-SemiBold'}}>jumps/day</Text>
                        ...
                        <View style={{width:'100%',justifyContent:'center', justifyContent:'center',marginTop: 12, marginBottom:18}}>
                            <Text style={{textAlign:'center', fontFamily:'SUIT-Regular',color:'#9ea4a9'}}>jumps total</Text>
                            <Text style={{textAlign:'center', fontFamily:'SUIT-Heavy', fontSize: 28, color:'#000'}}>{totalJumps} <Text style={{fontFamily:'SUIT-Regular',color:'#9ea4a9'}}>jumps</Text></Text>
                            <View style={{flexDirection:'row',justifyContent:'center', marginTop:24}}>
                                <View style={{justifyContent:'center', alignItems:'center'}} >
                                    <Text style={{textAlign:'center', fontFamily:'SUIT-Regular',color:'#9ea4a9'}}>mininng total</Text>
                                ...
                                <View style={{justifyContent:'center', alignItems:'center', marginLeft:18}} >
                                    <Text style={{textAlign:'center', fontFamily:'SUIT-Regular',color:'#9ea4a9'}}>calories total</Text>
                                ...
                                <View style={{justifyContent:'center', alignItems:'center', marginLeft:18}} >
                                    <Text style={{textAlign:'center', fontFamily:'SUIT-Regular',color:'#9ea4a9'}}>excercise time total</Text>
