...
const LoginView = ({clickHandler, isLogin}) => {
    ...
    useEffect(()=>{
        GoogleSignin.configure({ webClientId: '879653988026-78f2h0anqje9d3p7d0s8d5edooo4k9ub.apps.googleusercontent.com' });
    ...
    return <View style={styles.container}>
        ...
        <View style={styles.backgroundContainer}>
                ...
                <TouchableOpacity style={styles.googleLoginBtn} onPress={()=>{onGoogleButtonPress()}}>
                    ...
                    <Text style={{fontSize:18, marginLeft:42, color : 'black'}}>Google Login</Text>
                </TouchableOpacity>
